...
export const LiquidChrome = ({
  ...
  useEffect(() => {
    ...
    // Set clear color to transparent instead of white so it overlays correctly
  ...
  }, [baseColor, speed, amplitude, frequencyX, frequencyY, interactive, disableAnimation]);
